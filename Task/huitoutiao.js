...
let body ={"versionName":"4.3.0","platform":1,"count":1,"userId":151069331,"multiple":false,"channel":"dongfang","duration":30,"appVersion":1039,"loginId":"2e4062f0d4124c5a88bda1991a4b263f","readActionInfo":{"maxHistorySize":0,"toolTypes":[0],"moveAvgPressure":0,"downCount":112,"monkey":false,"moveCount":687,"downAvgPressure":0}};
let count=1;
  ...
  const request = {
	...
	$.post(request, async(error, request, data) =>{
      try {
			...
			{
				$.log(count+'成功获得'+JSON.parse(data).incCredit+'金币');
				count++;
			}
			else
			{
